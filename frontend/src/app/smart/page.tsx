    ...
    <div className="min-h-screen py-10 bg-muted/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="mb-8 space-y-3">
          <Link href="/" className="inline-flex items-center text-xs font-medium text-muted-foreground hover:text-primary transition-colors gap-1">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">No complex telemetry required — select your vehicle profile and driving state to derive ML parameters.</p>
            </div>
          </div>
        </div>
