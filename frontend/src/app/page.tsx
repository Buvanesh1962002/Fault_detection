              ...
              <CardContent className="space-y-4">
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-center gap-2">
                    ...
                    <span>20+ EV spec sheet database (Tata, MG, Ather, Ola, Tesla)</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="h-4 w-4 text-emerald-400 shrink-0" />
                    <span>Auto-fetches weather data (temp & humidity) via Geolocation</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="h-4 w-4 text-emerald-400 shrink-0" />
                    <span>Derives voltage, current, RPM, motor temp & vibration</span>
                  </li>
                </ul>
                <div className="pt-4">
            ...
            <Card className="relative overflow-hidden border-2 border-blue-500/30 bg-card/60 hover:border-blue-500/60 transition-all duration-300 shadow-md hover:shadow-blue-500/10 flex flex-col justify-between">
              ...
              <CardContent className="space-y-4">
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="h-4 w-4 text-emerald-400 shrink-0" />
                    <span>Direct input for Voltage, Current, RPM & Temperature</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="h-4 w-4 text-emerald-400 shrink-0" />
                    <span>Vibration level input in G-force (g)</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="h-4 w-4 text-emerald-400 shrink-0" />
                    <span>Supports pre-scaled operational inputs [0.0 - 1.0]</span>
                  </li>
                </ul>
                <div className="pt-4">
            ...
            {[
              {
                ...
                desc: "Pre-trained Random Forest classifier evaluating normalized feature vectors with confidence probability scoring.",
                color: "text-purple-400 bg-purple-500/10 border-purple-500/20",
              },
              {
                icon: Gauge,
                title: "Physics Parameter Engine",
                desc: "Translates battery SOC, driving mode profiles, and odometer wear into 7 calibrated electrical/mechanical features.",
                color: "text-emerald-400 bg-emerald-500/10 border-emerald-500/20",
              },
              {
                icon: CloudSun,
                title: "Weather Service",
                desc: "Integrates Open-Meteo API to fetch ambient temperature and humidity via browser geolocation.",
                color: "text-blue-400 bg-blue-500/10 border-blue-500/20",
              },
              {
                icon: ShieldCheck,
                title: "Operational Bounds",
                desc: "Validates sensor parameters against physical safety ranges before standard scaling and classification.",
